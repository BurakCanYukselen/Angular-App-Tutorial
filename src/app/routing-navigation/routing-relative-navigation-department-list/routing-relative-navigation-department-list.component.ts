...
@Component({
  selector: 'app-routing-relative-navigation-department-list',
  templateUrl: './routing-relative-navigation-department-list.component.html',
  styleUrls: ['./routing-relative-navigation-department-list.component.scss']
})
export class RoutingRelativeNavigationDepartmentListComponent implements OnInit {
